...
public class AccountController {
    ...
    private AccountRepository accountRepository; // ✅ これが必要！
...
public String listAccounts(@RequestParam(required = false) Integer year,
    ...
    System.out.println("カテゴリ別集計: " + categoryTotals);

    List<Account> accounts = accountService.getAccountsByMonth(year, month); // ✅ 修正！
    ...
    public String showForm(Model model) {
        ...
        return "account/form"; // resources/templates/account/form.html
    }
